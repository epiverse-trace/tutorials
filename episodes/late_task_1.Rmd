...
Mathematical models are useful tools for generating future trajectories of disease spread. Such models can be used to evalute the implementation of non-pharmaceutical and pharmaceutical interventions while accounting for factors such as age.
...
something on time end, increments and parameters 
