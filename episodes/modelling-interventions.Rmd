...
Mathematical models can be used to generate trajectories of disease spread under the implementation of non-pharmaceutical and pharmaceutical interventions at different stages of an outbreak. These predictions can be used to make decisions on what interventions could be implemented to slow down the spread of diseases. In this tutorial, we will introduce how to include different interventions in models.
...
ggplot() +
  aes(x = time, y = value) +
  stat_summary(
    data = output_school[output_school$compartment == "infectious", ],
    fun = sum,
    color = "black",
    geom = "line",
    linewidth = 1
  ...
  stat_summary(
    data = output[output$compartment == "infectious", ],
    fun = sum,
    color = "black",
    geom = "line",
    linewidth = 1,
...
ggplot() +
  aes(x = time, y = value) +
  stat_summary(
    data = output_masks[output_masks$compartment == "infectious", ],
    fun = sum,
    color = "black",
    geom = "line",
    linewidth = 1
...
ggplot() +
  aes(x = time, y = value) +
  stat_summary(
    data = output_vaccinate[output_vaccinate$compartment == "infectious", ],
    fun = sum,
    color = "black",
    geom = "line",
    linewidth = 1
