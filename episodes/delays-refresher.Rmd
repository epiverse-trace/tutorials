...
The package `{here}` simplifies file referencing in R projects. It reliably construct file paths relative to the project root. 

It works across different operating systems (Windows, Mac, Linux) without needing to adjust file paths. This property is known as **cross-Environment Compatibility**. For example:
...
cases_select <- cases %>%
  ...
  dplyr::mutate(outcome_delay = as.Date(date_of_outcome) - as.Date(date_of_hospitalisation)) %>%
