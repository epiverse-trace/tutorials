---
title: 'Introduction to outbreak analytics using R'
teaching: 10
exercises: 2
---
...
We can also explore missing data with summary visualizations:
...
Considering unknown outcomes underestimates the CFR calculation.
...
- Create **reproducible examples (reprex)**. A reprex help us to communicate our coding problems with software developers. Explore this Applied Epi entry: <https://community.appliedepi.org/t/how-to-make-a-reproducible-r-code-example/167>
