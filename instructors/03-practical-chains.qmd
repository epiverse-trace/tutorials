...
Use the file `03-practical-chains-act1.Rmd`

```{r, child = "03-practical-chains-act1.Rmd", echo = FALSE}
...
Use the file `03-practical-chains-act2.Rmd`

```{r, child = "03-practical-chains-act2.Rmd", echo = FALSE}
