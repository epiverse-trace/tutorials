...
Use the file `04-practical-late-act1.Rmd`

```{r, child = "04-practical-late-act1.Rmd", echo = FALSE}
...
Use the file `04-practical-late-act2.Rmd`

```{r, child = "04-practical-late-act2.Rmd", echo = FALSE}
...
Use the file `04-practical-late-act3.Rmd`

```{r, child = "04-practical-late-act3.Rmd", echo = FALSE}
