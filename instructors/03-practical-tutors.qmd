...
Use the file `03-practical-activity-1.Rmd`

```{r, child = "03-practical-activity-1.Rmd", echo = FALSE}
...
Use the file `03-practical-activity-2.Rmd`

```{r, child = "03-practical-activity-2.Rmd", echo = FALSE}
