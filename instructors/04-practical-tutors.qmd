...
Use the file `04-practical-activity-1.Rmd`

```{r, child = "04-practical-activity-1.Rmd", echo = FALSE}
...
Use the file `04-practical-activity-2.Rmd`

```{r, child = "04-practical-activity-2.Rmd", echo = FALSE}
...
Use the file `04-practical-activity-3.Rmd`

```{r, child = "04-practical-activity-3.Rmd", echo = FALSE}
