...
- Compare and describe the similarities and differences between these two outputs: the epidemic peak of *infectious individuals* across age groups, and the plot of *new infections* across age groups.
