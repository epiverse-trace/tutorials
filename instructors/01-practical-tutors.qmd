...
Use the file `01-practical-activity-1.Rmd`.

```{r, child = "01-practical-activity-1.Rmd", echo = FALSE}
...
Use the file `01-practical-activity-2.Rmd`.

```{r, child = "01-practical-activity-2.Rmd", echo = FALSE}
