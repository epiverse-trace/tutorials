...
2. In the step `read_rds()`, keep the reading function that corresponds to the disease of your group (as in table below).
3. Focus in getting 3 delays before running `EpiNow2::epinow()`
4. Paste screenshots of the summary table and plot outputs. Answer the questions below.
