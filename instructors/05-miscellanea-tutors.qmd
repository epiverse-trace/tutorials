...
format: 
  html: # learners solutions
    ...
    output-file: "05-miscellanea-solutions"
  docx:  # learners practical
    output-file: "05-miscellanea-guide"
...
In addition, it also covers how to compute the herd immunity threshold for a homogeneous population.
...
Calculate the final size of the epidemic, and compute the corresponding herd immunity threshold.
 
**Questions:**

Within your room, write your answers to these questions:

 1. What us the final size of the epidemic in a well-mixed community for the given $R_0$ value, and how do you interpret this result?
 2. What is the corresponding herd-immunity threshold, and how do you interpret this result?
...
- Open the file `05-miscellanea-activity-1.R` and complete all the lines marked with `#<COMPLETE>`, following the detailed steps provided within the R file.
...
- Open the file `05-miscellanea-activity-2.R` and complete all the lines marked with `#<COMPLETE>`, following the detailed steps provided within the R file.
