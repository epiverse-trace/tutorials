...
- What is the number of new infections at the moment of the epidemic peak?
- Change the basic reproduction number to 1.1 and 3. Are the changes in location (time) and size of peak of infectious as expected?
